...
const CartCount = ({onCartToggle,onClearCartItems,totalQTY}) => {
  return (
    ...
    <div className='flex items-center'>
        <button onClick={onClearCartItems} type='button'className='rounded bg-theme-cart active:scale-90 p-0.5'>
...
CartCount.propTypes = {
    onCartToggle:PropTypes.string.isRequired,
    onClearCartItems:PropTypes.string.isRequired,
