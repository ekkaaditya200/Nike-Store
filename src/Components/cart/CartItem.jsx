...
const CartItem = ({item:{id,title,text,img,price,color,shadow,cartQuantity}}) => {
  ...
  const onRemoveItem = () =>{
    dispath(setRemoveItemFromCart({id,title,text,img,price,color,shadow,cartQuantity}))
  }

  const onIncreaseItemQTY = () =>{
    dispath(setIncreaseItemQTY({id,title,text,img,price,color,shadow,cartQuantity}))
  }
  const onDecreaseItemQTY = () =>{
    dispath(setDecreaseItemQTY({id,title,text,img,price,color,shadow,cartQuantity}))
  }
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              <button onClick={onDecreaseItemQTY} type="button" className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90">
              ...
              <button onClick={onIncreaseItemQTY} type="button" className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90">
